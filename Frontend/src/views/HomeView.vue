<template>
  <div class="main-section">
    <div class="description-section">
      <h1 class="welcome-text">Welcome to BookBidder</h1>
      <p>Discover and bid on rare and popular books.</p>
    </div>
    <div class="books">
...
import { fetchAuctions } from '../../service/index.js'; 
...
onMounted(async () => {
  try {
    ...
    books.value = fetchedAuctions
      .filter(auction => auction.status === 'in_progress')
      .map(auction => ({
